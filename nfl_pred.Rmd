...
This extends the model to include injuries.
...
Now we're ready to fit the model in `Stan`.
...
## Distribution of home field advantage in model with injuries
...
As it will take a few weeks for the model to become stable, we expect home field advantage estimates to be around 0, especially with the injury parameter added. It's possible that the model doesn't quite yet know how to assign "blame" to home field advantage vs. injuries.

## Distribution of injury advantage
